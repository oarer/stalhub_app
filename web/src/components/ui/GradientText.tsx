...
export default function GradientText({
	...
	return (
		<motion.div
			className={`relative mx-auto flex max-w-fit flex-row items-center justify-center overflow-hidden font-medium transition-shadow duration-500 ${showBorder ? 'px-2 py-1' : ''} ${className}`}
